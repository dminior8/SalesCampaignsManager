...
INSERT INTO Account (id, owner, balance, role_id, created_at, updated_at) VALUES
                                                                           (1,'Jan Kowalski', 1000.00, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
                                                                           (2,'Anna Nowak', 2000.00, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO Campaign (id, product_id, account_id, name, bid_amount, fund, status, city_id, radius, created_at, updated_at) VALUES
                                                                                                                            ...
                                                                                                                            (2, 2, 2, 'Kampania Laptop ABC', 2.00, 1000.00, 'OFF', 2, 15, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
